...
bool vote(string name)
{
    // Iterate candidates searching by name
    // Look for a cadidate called name
...
void print_winner(void)
{
    // Print the name ofthe candidate(s) who have the most votes
    // Iterate candidates to calculate votes
